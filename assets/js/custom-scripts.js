...
//     xhr.open('get', './php.php?name=' + name + '&family=' + family + '&email=' + email + '&text=' + text, true);
//     xhr.send();
// })
...
function loadDoc() {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            var url = "https://hossein-heydari.ir";
            window.location = url;
        }
    };
    xhttp.open("GET", './php.php?name=' + name + '&family=' + family + '&email=' + email + '&text=' + text, true);
    xhttp.send();
}